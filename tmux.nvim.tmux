...
navigation_kb_next=$(get_tmux_option "@tmux-nvim-navigation-keybinding-next" 'C-n')
navigation_kb_previous=$(get_tmux_option "@tmux-nvim-navigation-keybinding-previous" 'C-p')
