...
To enable navigation beyond nvim, add one of the following to your `~/.tmux.conf`:
...
If you are using [tmux plugin manager](https://github.com/tmux-plugins/tpm) add this plugin:
